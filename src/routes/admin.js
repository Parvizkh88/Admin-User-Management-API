...
const { loginAdmin, logoutAdmin, getAllUsers, deleteUserByAdmin, exportUsers } = require('../controllers/admin');
...
// adminRouter.put('/dashboard', isLoggedIn, isAdmin, updateUserByAdmin);
